...
namespace TLC.SSP
{
	public class SpaceShipCamera : Camera
	{
		...
		public override void Activated()
		{
			...
			var car = (pawn as GroundPlayer)?.Vehicle as SpaceShipEntity;
		...
		private void DoThirdPerson( SpaceShipEntity car, PhysicsBody body )
		{

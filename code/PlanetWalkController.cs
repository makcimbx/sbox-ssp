...
{
	[Library]
	public class PlanetWalkController : BasePlayerController
	{
		...
		public override void Simulate()
		{
			...
			var planetUpVector = Position - Planet.Position;
			planetUpVector = planetUpVector.Normal;
			Rotation = Utils.FromToRotation( new Vector3( 0, 0, 1 ), planetUpVector );
		...
		private Vector3 CalculateCorrectVelocity( Vector3 velocity )
		{
			var planetUpVector = Position - Planet.Position;
			planetUpVector = planetUpVector.Normal;
			var defaultUpVector = new Vector3( 0, 0, 1 );
			var angle = Vector3.GetAngle( defaultUpVector, velocity );
			return Rotation.FromAxis( planetUpVector, angle ) * velocity * Utils.FromToRotation( velocity, planetUpVector );
		}
	}
}
